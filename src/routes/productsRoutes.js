...
router.get('/turnos', productsController.availability);
...
router.get('/pago', authMiddleware, productsController.paymentGateway);
router.post('/pago', authMiddleware, productsController.processPayment);
